...
def test():
    ...
    remove_containers()
    print("phase 0")
    initiate_container('https://zip-hudhomes.com/','tes_100', 'capture_notifications.js','0', 180 )    
    count=0
    print("phase 1")
    while count<2:
	...
	print("phase 2")
        time.sleep(300)
	print("phase 3")
        resume_container('https://zip-hudhomes.com/','tes_100','capture_notifications.js',count,180)
	print("phase 4")
        count=count+1
    print("phase 5")
